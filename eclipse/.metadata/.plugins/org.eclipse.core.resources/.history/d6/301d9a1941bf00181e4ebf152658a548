...
public class Timer
{
    ...
    public Timer(float ticksPerSeconds)
    {
        this.field_194149_e = 1000.0F / ticksPerSeconds;
    ...
    {
    	//LogManager.getLogger().warn(field_194149_e);
    	//this.field_194149_e = 1000.0F / Minecraft.getMinecraft().world.getGameRules().getInt("gameTicksPerSecond");
