...
public class EntityCreeper extends EntityMob
{
    ...
    private void explode()
    {
        if (!this.world.isRemote)
        {
            ...
            this.setDead();
            this.doPotionEffectZone();
        }
    }

    private void doPotionEffectZone()
    {
        Collection<PotionEffect> activePotionEffect = this.getActivePotionEffects();

        if (!activePotionEffect.isEmpty())
        {
            ...
            for (PotionEffect potioneffect : activePotionEffect)
            {
