...
{
    private NonNullList<ItemStack> minecartContainerItems = NonNullList.<ItemStack>func_191197_a(36, ItemStack.nullItemStack);
    ...
    public ItemStack removeStackFromSlot(int index)
    {
        ...
        {
            this.minecartContainerItems.set(index, ItemStack.nullItemStack);
            return itemstack;
        }
    }
    ...
    protected void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        this.minecartContainerItems = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(), ItemStack.nullItemStack);
