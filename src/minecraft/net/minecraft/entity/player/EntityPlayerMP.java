...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener
{
    ...
    {
        CriteriaTriggers.enterBlockTrigger.func_192193_a(this, p_191955_1_);
    }
    ...
    public void onUpdate()
    {
        ...
        CriteriaTriggers.tickTrigger.func_193182_a(this);

        if (this.field_193107_ct != null)
        {
            CriteriaTriggers.levitationTrigger.func_193162_a(this, this.field_193107_ct, this.ticksExisted - this.field_193108_cu);
        }
    ...
    public void onUpdateEntity()
    {
        try
        {
            ...
            {
                CriteriaTriggers.positionTrigger.func_192215_a(this);
            }
        }
    ...
    public void func_191956_a(Entity p_191956_1_, int p_191956_2_, DamageSource p_191956_3_)
    {
        if (p_191956_1_ != this)
        {
            ...
            CriteriaTriggers.playerKilledEntity.func_192211_a(this, p_191956_1_, p_191956_3_);
        }
    }
    ...
    public EntityPlayer.SleepResult trySleep(BlockPos bedLocation)
    {
        ...
        if (entityplayer$sleepresult == EntityPlayer.SleepResult.OK)
        {
            ...
            this.connection.sendPacket(packet);
            CriteriaTriggers.sleptInBedTrigger.func_192215_a(this);
        }
    ...
    public void sendSlotContents(Container containerToSend, int slotInd, ItemStack stack)
    {
        if (!(containerToSend.getSlot(slotInd) instanceof SlotCrafting))
        {
            ...
            {
                CriteriaTriggers.inventoryChangeTrigger.func_192208_a(this, this.inventory);
            }
    ...
    protected void onNewPotionEffect(PotionEffect id)
    {
        ...
        CriteriaTriggers.effectsChangedTrigger.func_193153_a(this);
    }
