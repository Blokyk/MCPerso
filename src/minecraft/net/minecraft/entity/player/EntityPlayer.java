...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    private ItemStack itemStackMainHand = ItemStack.nullItemStack;
    ...
    protected void damageShield(float damage)
    {
        if (damage >= 3.0F && this.activeItemStack.getItem() == Items.SHIELD)
        {
            ...
            if (this.activeItemStack.isNull())
            {
                ...
                {
                    this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, ItemStack.nullItemStack);
                }
                else
                {
                    this.setItemStackToSlot(EntityEquipmentSlot.OFFHAND, ItemStack.nullItemStack);
                }
    ...
    public ItemStack getItemStackFromSlot(EntityEquipmentSlot slotIn)
    {
        ...
        {
            return slotIn.getSlotType() == EntityEquipmentSlot.Type.ARMOR ? (ItemStack)this.inventory.armorInventory.get(slotIn.getIndex()) : ItemStack.nullItemStack;
        }
    }
