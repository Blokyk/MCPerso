...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant
{
    ...
    public void useRecipe(MerchantRecipe recipe)
    {
        ...
        {
            CriteriaTriggers.villagerTradeTrigger.func_192234_a((EntityPlayerMP)this.buyingPlayer, this, recipe.getItemToSell());
        }
    }
    ...
    public void verifySellingItem(ItemStack stack)
    {
        ...
        {
            this.livingSoundTime = -this.getTalkInterval();
            this.playSound(stack.isNull() ? SoundEvents.ENTITY_VILLAGER_NO : SoundEvents.ENTITY_VILLAGER_YES, this.getSoundVolume(), this.getSoundPitch());
        }
    }
    ...
    public boolean isFarmItemInInventory()
    {
        for (int i = 0; i < this.villagerInventory.getSizeInventory(); ++i)
        {
            ...
            if (!itemstack.isNull() && (itemstack.getItem() == Items.WHEAT_SEEDS || itemstack.getItem() == Items.POTATO || itemstack.getItem() == Items.CARROT || itemstack.getItem() == Items.BEETROOT_SEEDS))
            {
                return true;
            }
        }
