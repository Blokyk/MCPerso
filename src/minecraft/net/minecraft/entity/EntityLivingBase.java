...
public abstract class EntityLivingBase extends Entity
{
    ...
    private final NonNullList<ItemStack> handInventory = NonNullList.<ItemStack>func_191197_a(2, ItemStack.nullItemStack);
    private final NonNullList<ItemStack> armorArray = NonNullList.<ItemStack>func_191197_a(4, ItemStack.nullItemStack);
    ...
    protected ItemStack activeItemStack = ItemStack.nullItemStack;
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    CriteriaTriggers.entityHurtPlayerTrigger.func_192200_a((EntityPlayerMP)this, source, f, amount, flag);
                }

                if (entity1 instanceof EntityPlayerMP)
                {
                    CriteriaTriggers.playerHurtEntityTrigger.func_192220_a((EntityPlayerMP)entity1, this, source, f, amount, flag);
                }
