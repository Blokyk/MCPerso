...
public abstract class World implements IBlockAccess
{
    ...
    {
        return this.isChunkLoaded(x, y, false) ? true : this.chunkProvider.isChunkAt(x, y);
    }
    ...
    @Nullable
    public BlockPos func_190528_a(String p_190528_1_, BlockPos blockPos, boolean p_190528_3_)
    {
        return null;
    }
}
