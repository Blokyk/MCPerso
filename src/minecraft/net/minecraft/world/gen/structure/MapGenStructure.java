...
public abstract class MapGenStructure extends MapGenBase
{
    ...
    protected static BlockPos func_191069_a(World world, MapGenStructure mapGenStructure, BlockPos blockpos, int p_191069_3_, int p_191069_4_, int p_191069_5_, boolean p_191069_6_, int p_191069_7_, boolean p_191069_8_)
    {
            ...
            for (int l = -k; l <= k; ++l)
            {
                ...
                for (int i1 = -k; i1 <= k; ++i1)
                {
                    ...
                    if (flag || flag1)
                    {
                        ...
                        Random random1 = world.setRandomSeed(l1, i2, p_191069_5_);
                        l1 = l1 * p_191069_3_;
                        i2 = i2 * p_191069_3_;
                        ...
                        MapGenBase.func_191068_a(world.getSeed(), random, l1, i2);
                        random.nextInt();

                        if (mapGenStructure.canSpawnStructureAtCoords(l1, i2))
                        {
                            if (!p_191069_8_ || !world.isChunkLoadedAt(l1, i2))
                            {
