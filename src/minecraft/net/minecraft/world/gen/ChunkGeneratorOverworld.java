...
public class ChunkGeneratorOverworld implements IChunkGenerator
{
    ...
    private final WoodlandMansion woodlandmansion = new WoodlandMansion(this);
    ...
    public Chunk provideChunk(int x, int z)
    {
        ...
        if (this.mapFeaturesEnabled)
        {
            ...
            {
                this.woodlandmansion.generate(this.worldObj, x, z, chunkprimer);
            }
        }
    ...
    public void populate(int x, int z)
    {
        ...
        if (this.mapFeaturesEnabled)
        {
            ...
            if (this.settings.useMansions)
            {
                this.woodlandmansion.generateStructure(this.worldObj, this.rand, chunkpos);
            }
        }
    ...
    /**
     * Returns whatever there is the given structure at the given block position
     */
    public boolean isStructureAt(World world, String structureName, BlockPos blockpos)
    {
        if (!this.mapFeaturesEnabled)
        {
            return false;
        ...
        else if ("Mansion".equals(structureName) && this.woodlandmansion != null)
        {
            return this.woodlandmansion.isInsideStructure(blockpos);
        }
    ...
    public BlockPos getStrongholdGen(World worldIn, String structureName, BlockPos position, boolean p_180513_4_)
    {
        ...
        {
            return this.woodlandmansion.getClosestStrongholdPos(worldIn, position, p_180513_4_);
        }
        else if ("Monument".equals(structureName) && this.oceanMonumentGenerator != null)
        {
    ...
    public void recreateStructures(Chunk chunkIn, int x, int z)
    {
        if (this.mapFeaturesEnabled)
        {
            ...
            if (this.settings.useMansions)
            {
                this.woodlandmansion.generate(this.worldObj, x, z, (ChunkPrimer)null);
            }
        }
    }
}
