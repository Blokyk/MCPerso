...
public class AdvancementTreeNode
{
    ...
    {
        if (p_i47466_1_.getDisplayInfo() == null)
        {
        ...
        else
        {
            ...
            for (Advancement advancement : p_i47466_1_.getAdvancementSet())
            {
    ...
    {
        if (p_192322_1_.getDisplayInfo() != null)
        {
        ...
        {
            for (Advancement advancement : p_192322_1_.getAdvancementSet())
            {
    ...
    {
        if (this.field_192328_a.getDisplayInfo() != null)
        {
            this.field_192328_a.getDisplayInfo().func_192292_a((float)this.field_192335_h, this.field_192336_i);
        }
    ...
    {
        if (p_192323_0_.getDisplayInfo() == null)
        {
