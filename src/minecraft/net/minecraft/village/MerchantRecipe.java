...
public class MerchantRecipe
{
    ...
    {
        this.itemToBuy = ItemStack.nullItemStack;
        this.secondItemToBuy = ItemStack.nullItemStack;
        this.itemToSell = ItemStack.nullItemStack;
    ...
    {
        this(buy1, ItemStack.nullItemStack, sell);
    }
