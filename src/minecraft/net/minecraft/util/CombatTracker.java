            ...
            if (combatentry != null && combatentry1.getDamageSrc() == DamageSource.fall)
            {
                ...
                if (combatentry.getDamageSrc() != DamageSource.fall && combatentry.getDamageSrc() != DamageSource.outOfWorld)
                {
                    if (itextcomponent2 != null && (itextcomponent1 == null || !itextcomponent2.equals(itextcomponent1)))
                    {
                        ...
                        ItemStack itemstack1 = entity1 instanceof EntityLivingBase ? ((EntityLivingBase)entity1).getHeldItemMainhand() : ItemStack.nullItemStack;

                        if (!itemstack1.isNull() && itemstack1.hasDisplayName())
                        {
                    ...
                    {
                        ItemStack itemstack = entity instanceof EntityLivingBase ? ((EntityLivingBase)entity).getHeldItemMainhand() : ItemStack.nullItemStack;

                        if (!itemstack.isNull() && itemstack.hasDisplayName())
                        {
