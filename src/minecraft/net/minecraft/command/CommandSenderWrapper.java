...
public class CommandSenderWrapper implements ICommandSender
{
    ...
    /** 
     * Return a CommandSenderWrapper corresponding to the sender parameter
     * @param sender
     *  An ICommandSender object
     * @return
     */
    public static CommandSenderWrapper func_193998_a(ICommandSender sender)
    {
