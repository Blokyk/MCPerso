...
public class AdvancementCommand extends CommandBase
{
    ...
    private void func_193516_a(MinecraftServer p_193516_1_, ICommandSender p_193516_2_, String[] p_193516_3_, EntityPlayerMP p_193516_4_, AdvancementCommand.ActionType p_193516_5_, AdvancementCommand.Mode p_193516_6_) throws CommandException
    {
        if (p_193516_6_ == AdvancementCommand.Mode.EVERYTHING)
        {
            ...
            {
                int j = p_193516_5_.func_193532_a(p_193516_4_, p_193516_1_.getOverworldAvancementManager().func_192780_b());
        ...
        else
        {
            ...
            if (p_193516_6_ == AdvancementCommand.Mode.ONLY && p_193516_3_.length == 5)
            {
                ...
                if (!advancement.getStringCriterionMap().keySet().contains(s))
                {
                    throw new CommandException("commands.advancement.criterionNotFound", new Object[] {advancement.getLocation(), p_193516_3_[4]});
                }

                if (!p_193516_5_.func_193535_a(p_193516_4_, advancement, s))
                {
                    throw new CommandException(p_193516_5_.field_193541_d + ".criterion.failed", new Object[] {advancement.getLocation(), p_193516_4_.getName(), s});
                }

                notifyCommandListener(p_193516_2_, this, p_193516_5_.field_193541_d + ".criterion.success", new Object[] {advancement.getLocation(), p_193516_4_.getName(), s});
            }
            else
            {
                ...
                if (i == 0)
                {
                    throw p_193516_6_.func_193543_a(p_193516_5_, advancement.getLocation(), p_193516_4_.getName());
                }

                p_193516_6_.func_193546_a(p_193516_2_, this, p_193516_5_, advancement.getLocation(), p_193516_4_.getName(), i);
            }
        }
    }
    ...
    {
        for (Advancement advancement : p_193515_1_.getAdvancementSet())
        {
    ...
    private List<Advancement> func_193514_a(Advancement p_193514_1_, AdvancementCommand.Mode p_193514_2_)
    {
        ...
        {
            for (Advancement advancement = p_193514_1_.getAdvancement(); advancement != null; advancement = advancement.getAdvancement())
            {
    ...
    private void func_192554_c(ICommandSender p_192554_1_, EntityPlayerMP p_192554_2_, Advancement p_192554_3_, String p_192554_4_) throws CommandException
    {
        ...
        {
            throw new CommandException("commands.advancement.criterionNotFound", new Object[] {p_192554_3_.getLocation(), p_192554_4_});
        }
        else if (!criterionprogress.func_192151_a())
        {
            throw new CommandException("commands.advancement.test.criterion.notDone", new Object[] {p_192554_2_.getName(), p_192554_3_.getLocation(), p_192554_4_});
        }
        else
        {
            notifyCommandListener(p_192554_1_, this, "commands.advancement.test.criterion.success", new Object[] {p_192554_2_.getName(), p_192554_3_.getLocation(), p_192554_4_});
        }
    }
    ...
    private void func_192552_c(ICommandSender p_192552_1_, EntityPlayerMP p_192552_2_, Advancement p_192552_3_) throws CommandException
    {
        ...
        {
            throw new CommandException("commands.advancement.test.advancement.notDone", new Object[] {p_192552_2_.getName(), p_192552_3_.getLocation()});
        }
        else
        {
            notifyCommandListener(p_192552_1_, this, "commands.advancement.test.advancement.success", new Object[] {p_192552_2_.getName(), p_192552_3_.getLocation()});
        }
    }
        ...
        else
        {
            ...
            if (advancementcommand$actiontype != null)
            {
                ...
                if (advancementcommand$actiontype$mode != null && advancementcommand$actiontype$mode != AdvancementCommand.Mode.EVERYTHING)
                {
                    ...
                    {
                        Advancement advancement = server.getOverworldAvancementManager().getAdvancementFrom(new ResourceLocation(args[3]));

                        if (advancement != null)
                        {
                            return getListOfStringsMatchingLastWord(args, advancement.getStringCriterionMap().keySet());
                        }
                    }
                }
            }
            ...
            if ("test".equals(args[0]))
            {
                ...
                if (args.length == 4)
                {
                    Advancement advancement1 = server.getOverworldAvancementManager().getAdvancementFrom(new ResourceLocation(args[2]));

                    if (advancement1 != null)
                    {
                        return getListOfStringsMatchingLastWord(args, advancement1.getStringCriterionMap().keySet());
                    }
                }
            }
    ...
    private List<ResourceLocation> func_193517_a(MinecraftServer p_193517_1_)
    {
        ...
        for (Advancement advancement : p_193517_1_.getOverworldAvancementManager().func_192780_b())
        {
            list.add(advancement.getLocation());
        }
    ...
    {
        Advancement advancement = p_192551_0_.getOverworldAvancementManager().getAdvancementFrom(new ResourceLocation(p_192551_1_));
