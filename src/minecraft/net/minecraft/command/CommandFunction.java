...
public class CommandFunction extends CommandBase
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            FunctionObject functionObject = server.getOverworldFunctionManager().getFunctionByName(resourcelocation);
            ...
            else
            {
                ...
                int i = server.getOverworldFunctionManager().func_194019_a(functionObject, CommandSenderWrapper.func_193998_a(sender).func_194000_i().func_193999_a(2).func_194001_a(false));
