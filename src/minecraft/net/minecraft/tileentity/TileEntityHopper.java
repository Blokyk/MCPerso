...
{
    private NonNullList<ItemStack> inventory = NonNullList.<ItemStack>func_191197_a(5, ItemStack.nullItemStack);
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.inventory = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(), ItemStack.nullItemStack);
    ...
    private boolean isFull()
    {
        for (ItemStack itemstack : this.inventory)
        {
            if (itemstack.isNull() || itemstack.func_190916_E() != itemstack.getMaxStackSize())
            {
                return false;
            }
        }
    ...
    private boolean transferItemsOut()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    if (!this.getStackInSlot(i).isNull())
                    {
    ...
    private boolean isInventoryFull(IInventory inventoryIn, EnumFacing side)
    {
        if (inventoryIn instanceof ISidedInventory)
        {
            ...
            for (int k : aint)
            {
                ...
                if (itemstack1.isNull() || itemstack1.func_190916_E() != itemstack1.getMaxStackSize())
                {
                    return false;
                }
            }
    ...
    private static boolean isInventoryEmpty(IInventory inventoryIn, EnumFacing side)
    {
        if (inventoryIn instanceof ISidedInventory)
        {
            ...
            for (int i : aint)
            {
                if (!isidedinventory.getStackInSlot(i).isNull())
                {
                    return false;
                }
            }
        ...
        else
        {
            ...
            for (int k = 0; k < j; ++k)
            {
                if (!inventoryIn.getStackInSlot(k).isNull())
                {
                    return false;
                }
            }
    ...
    private static boolean pullItemFromSlot(IHopper hopper, IInventory inventoryIn, int index, EnumFacing direction)
    {
        ...
        if (!itemstack.isNull() && canExtractItemFromSlot(inventoryIn, itemstack, index, direction))
        {
    ...
    public static ItemStack putStackInInventoryAllSlots(IInventory inventoryIn, IInventory stack, ItemStack side, @Nullable EnumFacing p_174918_3_)
    {
        if (stack instanceof ISidedInventory && p_174918_3_ != null)
        {
            ...
            for (int k = 0; k < aint.length && !side.isNull(); ++k)
            {
