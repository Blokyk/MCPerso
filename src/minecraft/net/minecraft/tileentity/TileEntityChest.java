...
{
    private NonNullList<ItemStack> chestContents = NonNullList.<ItemStack>func_191197_a(27, ItemStack.nullItemStack);
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.chestContents = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(), ItemStack.nullItemStack);
