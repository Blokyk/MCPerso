...
public class TileEntityBrewingStand extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    private NonNullList<ItemStack> brewingItemStacks = NonNullList.<ItemStack>func_191197_a(5, ItemStack.nullItemStack);
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.brewingItemStacks = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(), ItemStack.nullItemStack);
    ...
    {
        return index >= 0 && index < this.brewingItemStacks.size() ? (ItemStack)this.brewingItemStacks.get(index) : ItemStack.nullItemStack;
    }
