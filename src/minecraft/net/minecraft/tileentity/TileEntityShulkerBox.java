...
public class TileEntityShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory
{
    ...
    {
        this.field_190596_f = NonNullList.<ItemStack>func_191197_a(27, ItemStack.nullItemStack);
    ...
    {
        this.field_190596_f = NonNullList.<ItemStack>func_191197_a(this.getSizeInventory(), ItemStack.nullItemStack);
