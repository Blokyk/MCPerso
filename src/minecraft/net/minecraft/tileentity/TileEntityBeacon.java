...
public class TileEntityBeacon extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    private ItemStack payment = ItemStack.nullItemStack;
    ...
    private void updateSegmentColors()
    {
        ...
        if (!this.world.isRemote && l < this.levels)
        {
            ...
            {
                CriteriaTriggers.constructBeaconTrigger.func_192180_a(entityplayermp, this);
            }
        }
    }
    ...
    {
        return index == 0 ? this.payment : ItemStack.nullItemStack;
    }
    ...
    public ItemStack decrStackSize(int index, int count)
    {
        if (index == 0 && !this.payment.func_190926_b())
        {
            if (count >= this.payment.func_190916_E())
            {
                ...
                this.payment = ItemStack.nullItemStack;
                return itemstack;
            }
            else
            {
