...
{
    public static final ItemStack nullItemStack = new ItemStack((Item)null);
    ...
    {
        this.field_190928_g = this.isNull();
    }
    ...
    /**
     * Could be IsNull() function 
     * @return
     */
    public boolean isNull()
    {
        if (this == nullItemStack)
        {
            return true;
        }
    ...
    /**
     * Write the stack fields (id, count, damage, and maybe additional item's tag) to a NBT object. Return the new NBT object.
     */
    public NBTTagCompound writeToNBT(NBTTagCompound nbt)
    {
        ResourceLocation longName = Item.REGISTRY.getNameForObject(this.item); // Gets the long name of the object(minecraft:objectname)
        nbt.setString("id", longName == null ? "minecraft:air" : longName.toString()); // Set the id of the NBT tag to the resource path (long name) of it
    ...
    public boolean attemptDamageItem(int amount, Random rand, @Nullable EntityPlayerMP p_96631_3_)
    {
        ...
        else
        {
            ...
            {
                CriteriaTriggers.itemDurabilityTrigger.func_193158_a(p_96631_3_, this, this.itemDamage + amount);
            }
    ...
    public static boolean areItemStackTagsEqual(ItemStack stackA, ItemStack stackB)
    {
        ...
        else if (!stackA.isNull() && !stackB.isNull())
        {
    ...
    public static boolean areItemStacksEqual(ItemStack stackA, ItemStack stackB)
    {
        ...
        {
            return !stackA.isNull() && !stackB.isNull() ? stackA.isItemStackEqual(stackB) : false;
        }
    }
    ...
    public static boolean areItemsEqual(ItemStack stackA, ItemStack stackB)
    {
        ...
        {
            return !stackA.isNull() && !stackB.isNull() ? stackA.isItemEqual(stackB) : false;
        }
    }
    ...
    public static boolean areItemsEqualIgnoreDurability(ItemStack stackA, ItemStack stackB)
    {
        ...
        {
            return !stackA.isNull() && !stackB.isNull() ? stackA.isItemEqualIgnoreDurability(stackB) : false;
        }
    }
    ...
    {
        return !other.isNull() && this.item == other.item && this.itemDamage == other.itemDamage;
    }
    ...
    public boolean isItemEqualIgnoreDurability(ItemStack stack)
    {
        ...
        {
            return !stack.isNull() && this.item == stack.item;
        }
    }
