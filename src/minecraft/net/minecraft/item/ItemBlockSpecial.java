...
public class ItemBlockSpecial extends Item
{
    ...
    public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY)
    {
        ...
        if (!itemstack.isNull() && stack.canPlayerEdit(worldIn, hand, itemstack) && playerIn.func_190527_a(this.block, worldIn, false, hand, (Entity)null))
        {
            ...
            else
            {
                ...
                if (iblockstate1.getBlock() == this.block)
                {
                    ...
                    {
                        CriteriaTriggers.placedBlockTrigger.func_193173_a((EntityPlayerMP)stack, worldIn, itemstack);
                    }
                }
