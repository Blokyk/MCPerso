    ...
    public static class RecipeAddPattern implements IRecipe
    {
        ...
        public ItemStack getCraftingResult(InventoryCrafting inv)
        {
            ...
            for (int i = 0; i < inv.getSizeInventory(); ++i)
            {
                ...
                if (!itemstack1.isNull() && itemstack1.getItem() == Items.BANNER)
                {
        ...
        {
            NonNullList<ItemStack> nonnulllist = NonNullList.<ItemStack>func_191197_a(inv.getSizeInventory(), ItemStack.nullItemStack);
                ...
                if (bannerpattern.func_191000_d())
                {
                    ...
                    if (bannerpattern.func_190999_e())
                    {
                        ...
                        for (int i = 0; i < p_190933_1_.getSizeInventory() && flag; ++i)
                        {
                            ...
                            if (!itemstack.isNull() && itemstack.getItem() != Items.BANNER)
                            {
    ...
    public static class RecipeDuplicatePattern implements IRecipe
    {
        public boolean matches(InventoryCrafting inv, World worldIn)
        {
            ...
            for (int i = 0; i < inv.getSizeInventory(); ++i)
            {
                ...
                if (!itemstack2.isNull())
                {
                    ...
                    if (!itemstack.isNull() && !itemstack1.isNull())
                    {
                        return false;
                    }
            ...
            return !itemstack.isNull() && !itemstack1.isNull();
        }
        ...
        public ItemStack getCraftingResult(InventoryCrafting inv)
        {
            for (int i = 0; i < inv.getSizeInventory(); ++i)
            {
                ...
                if (!itemstack.isNull() && TileEntityBanner.getPatterns(itemstack) > 0)
                {
