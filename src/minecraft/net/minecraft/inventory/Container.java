...
public abstract class Container
{
    ...
    protected Slot addSlotToContainer(Slot slotIn)
    {
        ...
        this.inventoryItemStacks.add(ItemStack.nullItemStack);
        return slotIn;
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        return slot != null ? slot.getStack() : ItemStack.nullItemStack;
    }
            ...
            if (!itemstack6.func_190926_b() || !itemstack10.func_190926_b())
            {
                if (itemstack6.func_190926_b())
                {
                    if (slot4.canTakeStack(player))
                    {
                        ...
                        slot4.putStack(ItemStack.nullItemStack);
                ...
                else if (itemstack10.func_190926_b())
                {
                    if (slot4.isItemValid(itemstack6))
                    {
                        ...
                        else
                        {
                            ...
                            inventoryplayer.setInventorySlotContents(dragType, ItemStack.nullItemStack);
                        }
                    }
                }
