...
public class InventoryBasic implements IInventory
{
    ...
    public InventoryBasic(String title, boolean customName, int slotCount)
    {
        ...
        this.inventoryContents = NonNullList.<ItemStack>func_191197_a(slotCount, ItemStack.nullItemStack);
    }
    ...
    {
        return index >= 0 && index < this.inventoryContents.size() ? (ItemStack)this.inventoryContents.get(index) : ItemStack.nullItemStack;
    }
    ...
    public ItemStack removeStackFromSlot(int index)
    {
        ...
        {
            this.inventoryContents.set(index, ItemStack.nullItemStack);
            return itemstack;
        }
    }
