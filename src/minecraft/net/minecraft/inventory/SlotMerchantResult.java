...
public class SlotMerchantResult extends Slot
{
    ...
    private boolean doTrade(MerchantRecipe trade, ItemStack firstItem, ItemStack secondItem)
    {
        ...
        {
            if (!itemstack1.isNull() && !secondItem.isNull() && itemstack1.getItem() == secondItem.getItem() && secondItem.func_190916_E() >= itemstack1.func_190916_E())
            {
            ...
            if (itemstack1.isNull() && secondItem.isNull())
            {
                firstItem.func_190918_g(itemstack.func_190916_E());
                return true;
            }
