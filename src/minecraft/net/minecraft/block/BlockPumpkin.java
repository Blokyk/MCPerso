...
public class BlockPumpkin extends BlockHorizontal
{
    ...
    private void trySpawnGolem(World worldIn, BlockPos pos)
    {
        ...
        if (blockpattern$patternhelper != null)
        {
            ...
            {
                CriteriaTriggers.summonedEntityTrigger.func_192229_a(entityplayermp, entitysnowman);
            }
        ...
        else
        {
            ...
            if (blockpattern$patternhelper != null)
            {
                ...
                {
                    CriteriaTriggers.summonedEntityTrigger.func_192229_a(entityplayermp1, entityirongolem);
                }
