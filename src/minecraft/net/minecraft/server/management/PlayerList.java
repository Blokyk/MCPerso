...
public abstract class PlayerList
{
    ...
    private final Map<UUID, PlayerAdvancements> uuidPlayerAdvancementsMap;
    ...
    public PlayerList(MinecraftServer server)
    {
        ...
        this.uuidPlayerAdvancementsMap = Maps.<UUID, PlayerAdvancements>newHashMap();
    ...
    public void preparePlayer(EntityPlayerMP playerIn, @Nullable WorldServer worldIn)
    {
        ...
        if (worldIn != null)
        {
            CriteriaTriggers.changeDimensionTrigger.func_193143_a(playerIn, worldIn.provider.getDimensionType(), worldserver.provider.getDimensionType());
            ...
            {
                CriteriaTriggers.netherTravelTrigger.func_193168_a(playerIn, playerIn.func_193106_Q());
            }
        }
    }
    ...
    protected void writePlayerData(EntityPlayerMP playerIn)
    {
        ...
        PlayerAdvancements playeradvancements = this.uuidPlayerAdvancementsMap.get(playerIn.getUniqueID());
    ...
    public void playerLoggedOut(EntityPlayerMP playerIn)
    {
        ...
        if (entityplayermp == playerIn)
        {
            ...
            this.uuidPlayerAdvancementsMap.remove(uuid);
        }
    ...
    public PlayerAdvancements func_192054_h(EntityPlayerMP p_192054_1_)
    {
        ...
        PlayerAdvancements playeradvancements = this.uuidPlayerAdvancementsMap.get(uuid);
        ...
        if (playeradvancements == null)
        {
            ...
            this.uuidPlayerAdvancementsMap.put(uuid, playeradvancements);
        }
    ...
    {
        for (PlayerAdvancements playeradvancements : this.uuidPlayerAdvancementsMap.values())
        {
