...
public abstract class MinecraftServer implements ICommandSender, Runnable, IThreadListener, ISnooperInfo
{
    ...
    public void updateTimeLightAndEntities()
    {
        ...
        this.getOverworldFunctionManager().update();
    ...
    public AdvancementManager getOverworldAvancementManager()
    {
        return this.worldServers[0].getAdvancementManager();
    }

    public FunctionManager getOverworldFunctionManager()
    {
        return this.worldServers[0].getFunctionManager();
    }
    ...
    public void func_193031_aM()
    {
        if (this.isCallingFromMinecraftThread())
        {
            ...
            this.getOverworldAvancementManager().func_192779_a();
            this.getOverworldFunctionManager().reset();
