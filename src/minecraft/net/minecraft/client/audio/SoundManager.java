...
public class SoundManager
{
    ...
    {
        String s = String.format("%s:%s:%s", "mcsounddomain", resourceLocation.getResourceDomain(), resourceLocation.getResourcePath());
    ...
    public void stop(String p_189567_1_, SoundCategory soundCategory)
    {
        if (soundCategory != null)
        {
            for (String s : this.categorySounds.get(soundCategory))
            {
                ISound isound = this.playingSounds.get(s);
    ...
    class SoundSystemStarterThread extends SoundSystem
    {
        ...
        public boolean playing(String sound)
        {
            synchronized (SoundSystemConfig.THREAD_SYNC)
            {
                ...
                {
                    Source source = (Source)this.soundLibrary.getSources().get(sound);
