...
public class ClientAdvancementManager
{
    ...
    public void func_192799_a(SPacketAdvancementInfo p_192799_1_)
    {
        ...
        {
            Advancement advancement = this.field_192802_c.getAdvancementFrom(entry.getKey());

            if (advancement != null)
            {
                AdvancementProgress advancementprogress = entry.getValue();
                advancementprogress.func_192099_a(advancement.getStringCriterionMap(), advancement.getRequirements());
                ...
                if (!p_192799_1_.func_192602_d() && advancementprogress.func_192105_a() && advancement.getDisplayInfo() != null && advancement.getDisplayInfo().func_193223_h())
                {
                    this.field_192801_b.func_193033_an().addToast(new AdvancementToast(advancement));
                }
            }
            else
            {
