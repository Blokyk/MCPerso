...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected Stats(Minecraft mcInstance)
        {
            super(mcInstance, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 20);
    ...
    {
        public StatsBlock(Minecraft mcInstance)
        {
            super(mcInstance);
    ...
    {
        public StatsGeneral(Minecraft mcInstance)
        {
            super(mcInstance, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 10);
            this.func_193651_b(false);
        }
    ...
    {
        public StatsItem(Minecraft mcInstance)
        {
            super(mcInstance);
            this.statsHolder = Lists.<StatCrafting>newArrayList();
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        public StatsMobsList(Minecraft mcInstance)
        {
            super(mcInstance, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, GuiStats.this.fontRendererObj.FONT_HEIGHT * 4);
            this.func_193651_b(false);
