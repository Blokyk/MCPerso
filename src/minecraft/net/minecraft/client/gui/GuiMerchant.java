...
public class GuiMerchant extends GuiContainer
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (merchantrecipelist != null && !merchantrecipelist.isEmpty())
        {
            ...
            if (this.isPointInRegion(36, 24, 16, 16, mouseX, mouseY) && !itemstack.isNull())
            {
                this.renderToolTip(itemstack, mouseX, mouseY);
            }
            else if (!itemstack1.isNull() && this.isPointInRegion(62, 24, 16, 16, mouseX, mouseY) && !itemstack1.isNull())
            {
                this.renderToolTip(itemstack1, mouseX, mouseY);
            }
            else if (!itemstack2.isNull() && this.isPointInRegion(120, 24, 16, 16, mouseX, mouseY) && !itemstack2.isNull())
            {
