...
public class GuiAdvancementTab extends Gui
{
    ...
    private final AdvancementTabType advancementTabType;
    ...
    public GuiAdvancementTab(Minecraft mcInstance, GuiScreenAdvancements p_i47589_2_, AdvancementTabType p_i47589_3_, int p_i47589_4_, Advancement p_i47589_5_, DisplayInfo p_i47589_6_)
    {
        this.mcInstance = mcInstance;
        this.field_193938_f = p_i47589_2_;
        this.advancementTabType = p_i47589_3_;
        ...
        this.field_191809_l = new GuiAdvancement(this, mcInstance, p_i47589_5_, p_i47589_6_);
    ...
    {
        this.advancementTabType.func_192651_a(this, p_191798_1_, p_191798_2_, p_191798_3_, this.field_191804_g);
    }

    public void func_191796_a(int p_191796_1_, int p_191796_2_, RenderItem p_191796_3_)
    {
        this.advancementTabType.func_192652_a(p_191796_1_, p_191796_2_, this.field_191804_g, p_191796_3_, this.field_191807_j);
    }
    ...
    public void func_191799_a()
    {
        ...
        {
            this.mcInstance.getTextureManager().bindTexture(resourcelocation);
        }
        else
        {
            this.mcInstance.getTextureManager().bindTexture(TextureManager.field_194008_a);
        }
    ...
    {
        return this.advancementTabType.func_192654_a(p_191793_1_, p_191793_2_, this.field_191804_g, p_191793_3_, p_191793_4_);
    }
    ...
    {
        if (p_193936_3_.getDisplayInfo() == null)
        {
            return null;
        }
        else
        {
            for (AdvancementTabType advancementtabtype : AdvancementTabType.values())
            {
                ...
                {
                    return new GuiAdvancementTab(p_193936_0_, p_193936_1_, advancementtabtype, p_193936_2_, p_193936_3_, p_193936_3_.getDisplayInfo());
                }
    ...
    {
        if (p_191800_1_.getDisplayInfo() != null)
        {
            GuiAdvancement guiadvancement = new GuiAdvancement(this, this.mcInstance, p_191800_1_, p_191800_1_.getDisplayInfo());
