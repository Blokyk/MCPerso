...
public class TutorialToast implements IToast
{
    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_)
    {
        ...
        {
            p_193653_1_.getMCInstance().fontRendererObj.drawString(this.field_193672_d, 30, 12, -11534256);
        }
        else
        {
            p_193653_1_.getMCInstance().fontRendererObj.drawString(this.field_193672_d, 30, 7, -11534256);
            p_193653_1_.getMCInstance().fontRendererObj.drawString(this.field_193673_e, 30, 18, -16777216);
        }
