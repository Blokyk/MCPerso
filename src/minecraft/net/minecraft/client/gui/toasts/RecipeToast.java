...
public class RecipeToast implements IToast
{
    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_)
    {
        ...
        else
        {
            ...
            p_193653_1_.getMCInstance().fontRendererObj.drawString(I18n.format("recipe.toast.title"), 30, 7, -11534256);
            p_193653_1_.getMCInstance().fontRendererObj.drawString(I18n.format("recipe.toast.description"), 30, 18, -16777216);
            RenderHelper.enableGUIStandardItemLighting();
            p_193653_1_.getMCInstance().getRenderItem().renderItemAndEffectIntoGUI((EntityLivingBase)null, this.field_193666_c.get((int)(p_193653_2_ / (5000L / (long)this.field_193666_c.size()) % (long)this.field_193666_c.size())), 8, 8);
    ...
    public static void func_193665_a(GuiToast p_193665_0_, IRecipe p_193665_1_)
    {
        ...
        if (recipetoast == null)
        {
            p_193665_0_.addToast(new RecipeToast(p_193665_1_.getRecipeOutput()));
        }
        else
        {
