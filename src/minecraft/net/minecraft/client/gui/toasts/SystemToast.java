...
public class SystemToast implements IToast
{
    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_)
    {
        ...
        {
            p_193653_1_.getMCInstance().fontRendererObj.drawString(this.field_193660_d, 18, 12, -256);
        }
        else
        {
            p_193653_1_.getMCInstance().fontRendererObj.drawString(this.field_193660_d, 18, 7, -256);
            p_193653_1_.getMCInstance().fontRendererObj.drawString(this.field_193661_e, 18, 18, -1);
        }
