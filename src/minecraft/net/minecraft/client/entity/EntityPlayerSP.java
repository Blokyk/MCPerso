...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public EntityPlayerSP(Minecraft mcInstance, World world, NetHandlerPlayClient connectionHandler, StatisticsManager statsManager, RecipeBook recipeBook)
    {
        super(world, connectionHandler.getGameProfile());
        this.connection = connectionHandler;
        this.statWriter = statsManager;
        this.field_192036_cb = recipeBook;
        this.mc = mcInstance;
        this.dimension = 0;
    }
    ...
    {
        this.inventory.setItemStack(ItemStack.nullItemStack);
        super.closeScreen();
