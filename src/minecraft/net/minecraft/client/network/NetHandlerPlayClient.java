...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleSpawnObject(SPacketSpawnObject packetIn)
    {
        ...
        {
            entity = new EntityFireworkRocket(this.clientWorldController, d0, d1, d2, ItemStack.nullItemStack);
        }
        ...
        {
            entity = new EntityPotion(this.clientWorldController, d0, d1, d2, ItemStack.nullItemStack);
            packetIn.setData(0);
        }
    ...
    public void func_194022_a(SPacketSelectAdvancementsTab p_194022_1_)
    {
        ...
        {
            Advancement advancement = this.field_191983_k.func_194229_a().getAdvancementFrom(resourcelocation);
