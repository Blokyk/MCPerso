...
public class GameSettings
{
    ...
    public static final String[] NARRATOR_OPTIONS = new String[] {"options.narrator.off", "options.narrator.all", "options.narrator.chat", "options.narrator.system"};
    ...
    public TutorialSteps tutoStepsMovement = TutorialSteps.MOVEMENT;
    ...
    public void setOptionValue(GameSettings.Options settingsOption, int value)
    {
        ...
        {
            if (NarratorChatListener.narratorChatListener.isNarratorActive())
            {
                this.narratorLevel = (this.narratorLevel + value) % NARRATOR_OPTIONS.length /* NARRATOR_OPTIONS.length = 4 */;
                this.LOGGER.warn("You know you've gone deep enough. Field value is " + this.narratorLevel);
            }
            else
            {
                this.narratorLevel = 0;
            }
            
            NarratorChatListener.narratorChatListener.setNarratorLevel(this.narratorLevel);
        }
    ...
    public String getKeyBinding(GameSettings.Options settingOption)
    {
        ...
        {
            return NarratorChatListener.narratorChatListener.isNarratorActive() ? s + getTranslation(NARRATOR_OPTIONS, this.narratorLevel) : s + I18n.format("options.narrator.notavailable");
        }
        else
        {
            return s;
        ...
        try
        {
            ...
            for (String s1 : nbttagcompound.getKeySet())
            {
                ...
                try
                {
                    ...
                    {
                        this.tutoStepsMovement = TutorialSteps.func_193307_a(s2);
                    }
                    ...
                    {
                        this.narratorLevel = Integer.parseInt(s2);
                    }
    ...
    public void saveOptions()
    {
        ...
        try
        {
            ...
            printwriter.println("narrator:" + this.narratorLevel);
            printwriter.println("tutorialStep:" + this.tutoStepsMovement.func_193308_a());
